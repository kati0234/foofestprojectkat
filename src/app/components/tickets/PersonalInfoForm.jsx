...
const PersonalInfoForm = ({ onNext, onBack, formData }) => {
  ...
  return (
    <>
      <div>
        <h1 className="text-stor font-medium">Personlige oplysninger</h1>
        <p>udfyld oplysinger ?????????</p>
        <form onSubmit={handleSubmit(onSubmit)} className="w-full h-full grid">
          <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4 px-10">
                ...
                (ticket, index) => (
                  <div key={index} className="">
                    <div className="flex justify-between items-center">
                      ...
                      <p>{index < formData.vipCount ? "VIP" : "Regular"}</p>
                    </div>
                    <div className=" rounded-lg shadow-gray-400  shadow-md bg-white border-gray-400 py-8 px-6 mb-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <input
                          ...
                          className="border-[1px] border-gray-500 p-2 bg-gray-100 text-base focus:outline-none focus:ring-2 focus:ring-customPink"
                          // className={`border-2 p-2 text-base focus:outline-none focus:ring-2 ${
                          //   errors.tickets?.[index]?.email
                          //     ? "border-red-500 focus:ring-red-500"
                          //     : "border-lime-400 focus:ring-black"
                      ...
                      <div className="flex flex-col">
                        ...
                        <input
                          ...
                          className="border-[1px] border-black bg-gray-50 p-2 text-base focus:outline-none focus:ring-2 focus:ring-customPink"
                          // className={`border-2 p-2 text-base focus:outline-none focus:ring-2 ${
                          //   errors.tickets?.[index]?.email
